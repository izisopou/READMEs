Lines with $ in front of them are commands to run in terminal.

In order to modify files in CMS Connect do
$ nano file.txt  //(same as pico)
...
This makes the gridpacks. When it's done test it by doing:
...
You can fine that file made by Eva in: /home/izisopou/genproductions/bin/MadGraph5_aMCatNLO
